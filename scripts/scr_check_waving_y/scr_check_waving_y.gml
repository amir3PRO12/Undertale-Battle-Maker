function scr_check_waving_y(){
	...
	wave_intensity_y = real(string_copy(text_to_draw,draw_chara_temp+symbols_number,i-symbols_number-1))
	...
	wave_shortness_y = real(string_copy(text_to_draw,draw_chara_temp+symbols_number,i-symbols_number-1))
	...
	wave_speed_y = real(string_copy(text_to_draw,draw_chara_temp+symbols_number,i-symbols_number-1))
	
	if wave_intensity_y > 0 
	is_waving = 1
	else
	is_waving = 0
	draw_chara--
